...
function internal.DrawBiomeTab_Tartarus(imgui, session)
    internal.DrawSectionHeading(imgui, "Minibosses", { 0.88, 0.38, 0.32, 1.0 })
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("RatCatcher", "I"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("GoldElemental", "I"))
end
