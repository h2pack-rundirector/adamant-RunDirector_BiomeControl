...
function internal.DrawBiomeTab_Olympus(imgui, session)
    internal.DrawSectionHeading(imgui, "Rooms", { 0.90, 0.82, 0.56, 1.0 })
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Dionysus", "P"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Fountain", "P"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Shop", "P"))

    imgui.Spacing()
    internal.DrawSectionHeading(imgui, "Minibosses", { 0.88, 0.38, 0.32, 1.0 })
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Talos", "P"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Dragon", "P"))
end
