...
function internal.DrawBiomeTab_Erebus(imgui, uiState)
    internal.DrawSectionHeading(imgui, "Rooms", { 0.90, 0.82, 0.56, 1.0 })
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Arachne", "F"))
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Trial", "F"))
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Fountain", "F"))
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Shop", "F"))

    imgui.Spacing()
    internal.DrawSectionHeading(imgui, "Minibosses", { 0.88, 0.38, 0.32, 1.0 })
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Treant", "F"))
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("FogEmitter", "F"))
    internal.DrawRoomRow(imgui, uiState, internal.GetRoomDef("Assassin", "F"))
end
