...
function internal.DrawBiomeTab_Oceanus(imgui, session)
    internal.DrawSectionHeading(imgui, "Rooms", { 0.90, 0.82, 0.56, 1.0 })
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Narcissus", "G"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Trial", "G"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Fountain", "G"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Shop", "G"))

    imgui.Spacing()
    internal.DrawSectionHeading(imgui, "Minibosses", { 0.88, 0.38, 0.32, 1.0 })
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("WaterUnit", "G"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Crawler", "G"))
    internal.DrawRoomRow(imgui, session, internal.GetRoomDef("Jellyfish", "G"))
end
